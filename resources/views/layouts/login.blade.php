...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href=" {{ asset('public/assets/admin/vendors/css/forms/icheck/icheck.css') }}">
    <link rel="stylesheet" type="text/css"
        href=" {{ asset('public/assets/admin/vendors/css/forms/icheck/custom.css') }}">
    <!-- END VENDOR CSS-->
    <!-- BEGIN MODERN CSS-->
    ...
    <link rel="stylesheet" type="text/css"
        href=" {{ asset('public/assets/admin/css-rtl/core/colors/palette-gradient.css') }}">
...
<body class="vertical-layout vertical-menu 1-column   menu-expanded blank-page blank-page" data-open="click"
    ...
    <script src=" {{ asset('public/assets/admin/vendors/js/forms/icheck/icheck.min.js') }}" type="text/javascript">
    </script>
    ...
    <!-- END MODERN JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src=" {{ asset('public/assets/admin/js/scripts/forms/form-login-register.js') }}" type="text/javascript">
    </script>
    <!-- END PAGE LEVEL JS-->
