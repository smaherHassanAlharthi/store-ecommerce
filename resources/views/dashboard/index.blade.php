            ...
            <div class="content-body">
                                ...
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>{{ __('translation.total_sales') }}</h4>
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>{{ __('translation.total_orders') }}</h4>
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>{{ __('translation.number_products') }}</h4>
                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>{{ __('translation.number_clients') }}</h4>
                                            {{-- <h6 class="text-muted">Balance</h6> --}}
                                        </div>
                                        <div class="col-5 text-right">
                                            <h4>$1.2</h4>
                ...
                <div class="row match-height">
                    <div class="col-12 col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('translation.latest_orders') }}</h4>
                                    ...
                                    <table class="table table-de mb-0">
                                        ...
                                        <tbody>
                                            <tr class="bg-success bg-lighten-5">
                                                ...
                                                <td>سماهر الحارثي</td>
                                                <td>4000</td>
                                                <td><i class="cc BTC-alt"></i>فعال</td>
                                                <td>$ 4762.53</td>
                                            </tr>
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('translation.latest_reviews') }}</h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                <div class="heading-elements">
